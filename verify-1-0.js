		...
		if(state && state == 'captcha') {
			...
			serverDescElement.textContent = captchaRequireDesc ?? "This server requires a captcha. Click the captcha below to verify.";
				...
				if(body.success) {
					...
					serverDescElement.innerHTML = verifySuccessDesc !== 'custom' ? verifySuccessDesc : "Complete! Unlink to unsubscribe, email <a class=\"text-red-500 animate-pulse\" href=\"mailto:wz.samu@gmail.com\">wz.samu@gmail.com</a> to report abuse (US laws only)";
				}
				else {
